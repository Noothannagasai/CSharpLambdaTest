...
namespace SeleniumcSharp
{
    ...
    public class TestClass
    {
        ...
        public void init()
        {
            ...
            driver = new RemoteWebDriver(new Uri("https://panabakamnoothan:nTJGmEd5ONboKwHcZiC0TrsNoGtqsTfrks2UCrYwQmYMiZPLSM@hub.lambdatest.com/wd/hub"), capabilities, TimeSpan.FromSeconds(600));
